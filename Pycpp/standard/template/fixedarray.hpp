...
#pragma region Declaration : Fixed Array
	...
	class FixedArray final : public List, public Arguments, public __FixedArray<Capacity>
	{
	public:
	...
	#pragma region Constructors & Destructor
		...
		FixedArray() = default;
		FixedArray(std::initializer_list<Object*> list) = default;
		FixedArray(Iterable* iterable) = default;
